...
- `GET /api/ccstatusline/usages` - Get Claude AI usage data from Archon's usage cache (`~/.cache/archon/usages.json`); populated by built-in background fetcher; returns 404 when file absent
